...
document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector('div.entry-content[itemprop="articleBody"]');if(!e)return;const t=e.querySelectorAll("p");if(0===t.length)return;let n=[0];for(let e=6;e<t.length&&n.length<8;e+=6)n.push(e);n.forEach((n,o)=>{const r=`yandex_rtb_R-A-15147749-1-${o+1}`,d=document.createElement("div");d.id=r,d.style.margin="5px";const a=t[n];a&&a.parentNode&&a.parentNode.insertBefore(d,a.nextSibling),window.yaContextCb.push(()=>{Ya.Context.AdvManager.render({blockId:"R-A-15147749-1",renderTo:r})})})});
